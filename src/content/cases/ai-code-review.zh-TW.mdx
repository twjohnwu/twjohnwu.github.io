...
tagline: Profile-driven · 跨 28 個服務 main pipeline 的 GitLab MR 自動審查（LLM 驅動，架構支援切換 provider）
heroMetrics:
  - { value: 28, label: "main pipeline 接入服務數" }
...
## Impact
- v1.0 → v2.0：15 → 28 個服務 main pipeline 接入（另 40 個已註冊）
